...
<h2 class="wc-tapsi-locations-heading">
    ...
    <a href="<?php echo admin_url('admin.php?page=wc-settings&tab=woo-tapsi-delivery&section=locations&location_id=new'); ?>"
       class="page-title-action"><?php esc_html_e('Add pickup location', 'woo-tapsi-delivery'); ?></a>
</h2>
...
<script type="text/html" id="tmpl-wc-tapsi-location-row-blank">
    ...
    <tr>
        <td class="wc-tapsi-locations-blank-state" colspan="5">
            ...
            <a class="button button-primary wc-tapsi-location-add"
               href="<?php echo esc_url(admin_url('admin.php?page=wc-settings&tab=woo-tapsi-delivery&section=locations&location_id=new')); ?>"><?php _e('Add pickup location', 'woo-tapsi-delivery'); ?></a>
        </td>
    </tr>
    <?php //endif; ?>
</script>
...
<script type="text/html" id="tmpl-wc-tapsi-location-row">
    <tr data-id="{{ data.location_id }}">
        ...
        <td class="wc-tapsi-location-name">
            <a href="<?php echo esc_url(admin_url('admin.php?page=wc-settings&tab=woo-tapsi-delivery&section=locations&location_id=')); ?>{{ data.location_id }}">{{
                data.location_name }}</a>
            <div class="row-actions">
                ...
                |
                <a href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=wc-settings&tab=woo-tapsi-delivery&section=locations'), 'delete_location')); ?>&amp;delete_location={{ data.location_id }}"
                   class="wc-tapsi-location-delete"><?php _e('Delete', 'woo-tapsi-delivery'); ?></a>
