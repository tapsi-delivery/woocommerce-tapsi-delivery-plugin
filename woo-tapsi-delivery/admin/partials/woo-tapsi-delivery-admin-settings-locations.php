	...
	<?php //if ( 0 === $method_count ) : ?>
		<tr>
			<td class="wc-tapsi-locations-blank-state" colspan="5">
				...
				<a class="button button-primary wc-tapsi-location-add" href="<?php echo esc_url( admin_url( 'admin.php?page=wc-settings&tab=woo-tapsi-delivery&section=locations&location_id=new' ) ); ?>"><?php _e( 'Add pickup location', 'woo-tapsi-delivery' ); ?></a>
			</td>
		</tr>
	<?php //endif; ?>
</script>
...
<script type="text/html" id="tmpl-wc-tapsi-location-row">
	<tr data-id="{{ data.location_id }}">
		...
		<td class="wc-tapsi-location-name">
			<a href="<?php echo esc_url( admin_url( 'admin.php?page=wc-settings&tab=woo-tapsi-delivery&section=locations&location_id=' ) ); ?>{{ data.location_id }}">{{ data.location_name }}</a>
			<div class="row-actions">
				<a href="<?php echo esc_url( admin_url( 'admin.php?page=wc-settings&tab=woo-tapsi-delivery&section=locations&location_id=' ) ); ?>{{ data.location_id }}"><?php _e( 'Edit', 'woo-tapsi-delivery' ); ?></a> |
				<a href="<?php echo esc_url( wp_nonce_url( admin_url( 'admin.php?page=wc-settings&tab=woo-tapsi-delivery&section=locations' ), 'delete_location' ) ); ?>&amp;delete_location={{ data.location_id }}" class="wc-tapsi-location-delete"><?php _e( 'Delete', 'woo-tapsi-delivery' ); ?></a>
				<!-- <a href="admin.php?page=wc-settings&amp;tab=woo-tapsi-delivery&amp;section=locations&amp;location_id={{ data.location_id }}"><?php _e( 'Edit', 'woo-tapsi-delivery' ); ?></a> | <a href="admin.php?page=wc-settings&amp;tab=woo-tapsi-delivery&amp;section=locations&amp;location_delete={{ data.location_id }}" class="wc-tapsi-location-delete"><?php _e( 'Delete', 'woo-tapsi-delivery' ); ?></a> -->
			</div>
		</td>
		...
		<td class="wc-tapsi-location-hours">
			...
			<a class="wc-tapsi-location-hours-toggle-enabled" href="<?php echo esc_url( wp_nonce_url( admin_url( 'admin.php?page=wc-settings&tab=woo-tapsi-delivery&section=locations' ), 'location_toggle_hours' ) ); ?>&amp;location_toggle_hours={{data.location_id}}">
		...
		<td class="wc-tapsi-location-enabled">
			...
			<a class="wc-tapsi-location-toggle-enabled" href="<?php echo esc_url( wp_nonce_url( admin_url( 'admin.php?page=wc-settings&tab=woo-tapsi-delivery&section=locations' ), 'location_toggle_enabled' ) ); ?>&amp;location_toggle_enabled={{data.location_id}}">
