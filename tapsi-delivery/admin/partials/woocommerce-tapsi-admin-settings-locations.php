...
<table class="wc-tapsi-locations widefat">
	<thead>
		<tr>
			<th class="wc-tapsi-location-sort"><?php echo wc_help_tip( __( 'Drag and drop to re-order your custom zones. This is the order in which they will be matched against the customer address.', 'tapsi-delivery' ) ); ?></th>
			<th class="wc-tapsi-location-name"><?php esc_html_e( 'Location name', 'tapsi-delivery' ); ?></th>
			<th class="wc-tapsi-location-address"><?php esc_html_e( 'Address', 'tapsi-delivery' ); ?></th>
			<th class="wc-tapsi-location-hours"><?php esc_html_e( 'Custom Hours', 'tapsi-delivery' ); ?></th>
			<th class="wc-tapsi-location-enabled"><?php esc_html_e( 'Location Enabled', 'tapsi-delivery' ); ?></th>
		</tr>
	</thead>
	...
	<?php //if ( 0 === $method_count ) : ?>
		<tr>
			<td class="wc-tapsi-locations-blank-state" colspan="5">
				<p class="main"><?php _e( 'Pickup locations can be configured for each of the physical locations of your business.', 'tapsi-delivery' ); ?></p>
				<p><?php _e( 'Each location can be configured with:', 'tapsi-delivery' ); ?></p>
				<ul>
					<li><?php _e( '<em>Location Name</em>', 'tapsi-delivery' ); ?>
					<li><?php _e( '<em>Location Address</em> where orders will be picked up by Dashers', 'tapsi-delivery' ); ?>
					<li><?php _e( '<em>Open Hours</em> for the location, which determine when users will be able to select this location for Tapsi', 'tapsi-delivery' ); ?>
					<li><?php _e( '<em>Lead Time</em> that is required for orders to be filled at this location.', 'tapsi-delivery' ); ?>
				</ul>
				<p><?php _e( 'Users will be able to select the location their order will be fulfilled from during checkout.', 'tapsi-delivery' ); ?></p>
				<a class="button button-primary wc-tapsi-location-add" href="<?php echo esc_url( admin_url( 'admin.php?page=wc-settings&tab=woocommerce-tapsi&section=locations&location_id=new' ) ); ?>"><?php _e( 'Add pickup location', 'tapsi-delivery' ); ?></a>
			</td>
		</tr>
	<?php //endif; ?>
</script>
