 ...
 * @subpackage Tapsi_Woo_Delivery/admin/partials
 */

$date_settings = get_option('tapsi_woo_delivery_date_settings');
$time_settings = get_option('tapsi_woo_delivery_time_settings');
if(isset($date_settings['delivery_days'])) {
	$selected_delivery_day = explode(',', get_option('tapsi_woo_delivery_date_settings')['delivery_days']);
} else {
...
?>
<div class="tapsi-woo-delivery-wrap">

<div class="tapsi-woo-delivery-container">
	<div class="tapsi-woo-delivery-container-header">
		<img style="max-width: 75px;float: left;display: block;padding-bottom: 2px;" src="<?php echo TAPSI_WOO_DELIVERY_URL; ?>admin/images/woo-delivery-logo.png" alt="tapsi-woo-delivery">
...
<!--                            Login-->
            ...
            <div data-tab="tab1" class="tapsi-woo-delivery-tabcontent">
				<div class="tapsi-woo-delivery-card">
					...
					<div class="tapsi-woo-delivery-card-body">
						<p class="tapsi-woo-delivery-timezone-tab-notice"><span class="dashicons dashicons-yes"></span><?php _e(' Settings Changed Successfully', 'woo-delivery'); ?></p>
						<p class="tapsi-woo-delivery-timezone-tab-warning"><span class="dashicons dashicons-megaphone"></span><?php _e(' Before All the Settings, Please Set Your Timezone First, Otherwise We Are Using the WordPress Timezone.', 'woo-delivery'); ?></p>
	                    <form action="" method="post" id ="tapsi_delivery_timezone_form_submit">
	                        <?php wp_nonce_field('tapsi_woo_delivery_nonce'); ?>

	                    	<div class="tapsi-woo-delivery-form-group" id="tapsi_delivery_time_timezone">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_delivery_time_timezone"><?php _e('Store Location Timezone', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Delivery date and time of all orders will set according to the selected timezone"><span class="dashicons dashicons-editor-help"></span></p>
								<select class="tapsi-woo-delivery-select-field" name="tapsi_delivery_time_timezone">
	                        ...
	                        <input class="tapsi-woo-delivery-submit-btn" type="submit" name="tapsi_delivery_timezone_form_submit" value="<?php _e('Save Changes', 'woo-delivery'); ?>" />
				...
				<div class="tapsi-woo-delivery-card">
					...
					<div class="tapsi-woo-delivery-card-body">
	                    ...
	                    <form action="" method="post" id ="tapsi_delivery_delivery_option_form_submit">
	                        ...
	                        <div class="tapsi-woo-delivery-form-group">
	                        	<span class="tapsi-woo-delivery-form-label" style="width:426px!important"><?php _e('Give Option to choose from Delivery or Pickup', 'woo-delivery'); ?></span>
	                        	<p class="tapsi-woo-delivery-tooltip" tooltip="Enable it if you want to give the freedom to customer whether he wants Home delivery or he picks the ordered products from a pickup location. Default is disable."><span class="dashicons dashicons-editor-help"></span></p>
							    <label class="tapsi-woo-delivery-toogle-switch" for="tapsi_enable_option_time_pickup">
							       <input type="checkbox" name="tapsi_enable_option_time_pickup" id="tapsi_enable_option_time_pickup" <?php echo (isset($delivery_option_settings['enable_option_time_pickup']) && !empty($delivery_option_settings['enable_option_time_pickup'])) ? "checked" : "" ?>/>
							       <div class="tapsi-woo-delivery-toogle-slider tapsi-woo-delivery-toogle-round"></div>
							    </label>
	                    	</div>
	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_woo_delivery_delivery_option_label"><?php _e('Order Type Field Label', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Order Type field label. Default is Order Type."><span class="dashicons dashicons-editor-help"></span></p>
	                        	<input id="tapsi_woo_delivery_delivery_option_label" name="tapsi_woo_delivery_delivery_option_label" type="text" class="tapsi-woo-delivery-input-field" value="<?php echo (isset($delivery_option_settings['delivery_option_label']) && !empty($delivery_option_settings['delivery_option_label'])) ? stripslashes($delivery_option_settings['delivery_option_label']) : "" ?>" placeholder="" autocomplete="off"/>
	                    	</div>
	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_woo_delivery_option_delivery_label"><?php _e('Delivery Option Label', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Order Type's Home Delivery option label. Default is Delivery."><span class="dashicons dashicons-editor-help"></span></p>
	                        	<input id="tapsi_woo_delivery_option_delivery_label" name="tapsi_woo_delivery_option_delivery_label" type="text" class="tapsi-woo-delivery-input-field" value="<?php echo (isset($delivery_option_settings['delivery_label']) && !empty($delivery_option_settings['delivery_label'])) ? stripslashes($delivery_option_settings['delivery_label']) : "" ?>" placeholder="" autocomplete="off"/>
	                    	</div>

	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_woo_delivery_option_pickup_label"><?php _e('Self Pickup Option Label', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Order Type's Self Pickup option label. Default is Pickup."><span class="dashicons dashicons-editor-help"></span></p>
	                        	<input id="tapsi_woo_delivery_option_pickup_label" name="tapsi_woo_delivery_option_pickup_label" type="text" class="tapsi-woo-delivery-input-field" value="<?php echo (isset($delivery_option_settings['pickup_label']) && !empty($delivery_option_settings['pickup_label'])) ? stripslashes($delivery_option_settings['pickup_label']) : "" ?>" placeholder="" autocomplete="off"/>
	                    	</div>
	                    	<div class="tapsi-woo-delivery-form-group">
	                        	<span class="tapsi-woo-delivery-form-label"><?php _e('Dynamically Enable/Disable Delivery/Pickup Based on WooCommerce Shipping', 'woo-delivery'); ?></span>
	                        	<p class="tapsi-woo-delivery-tooltip" tooltip="Enable it if you want to see the delivery or pickup option based on your WoCommerce Shipping. Default is disable."><span class="dashicons dashicons-editor-help"></span></p>
							    <label class="tapsi-woo-delivery-toogle-switch" for="tapsi_woo_delivery_enable_dynamic_order_type">
							       <input type="checkbox" name="tapsi_woo_delivery_enable_dynamic_order_type" id="tapsi_woo_delivery_enable_dynamic_order_type" class="tapsi_woo_delivery_enable_dynamic_order_type"/>
							       <div class="tapsi-woo-delivery-toogle-slider tapsi-woo-delivery-toogle-round"></div>
							    </label>
	                    	</div>

	                    	<div class="tapsi-woo-delivery-form-group">
	                        	<span class="tapsi-woo-delivery-form-label"><?php _e('Dynamically Change Shipping Method Based on Delivery/Pickup', 'woo-delivery'); ?></span>
	                        	<p class="tapsi-woo-delivery-tooltip" tooltip="Enable it if you want to see the delivery or pickup option based on your WoCommerce Shipping. Default is disable."><span class="dashicons dashicons-editor-help"></span></p>
							    <label class="tapsi-woo-delivery-toogle-switch" for="tapsi_woo_delivery_enable_dynamic_order_type">
							       <input type="checkbox" name="tapsi_woo_delivery_enable_dynamic_order_type" id="tapsi_woo_delivery_enable_dynamic_order_type" class="tapsi_woo_delivery_enable_dynamic_order_type"/>
							       <div class="tapsi-woo-delivery-toogle-slider tapsi-woo-delivery-toogle-round"></div>
			...
			<div data-tab="tab3" class="tapsi-woo-delivery-tabcontent">
				...
				<div class="tapsi-woo-delivery-card">
					<p class="tapsi-woo-delivery-card-header"><?php _e('General Delivery Date Settings', 'woo-delivery'); ?></p>
					<div class="tapsi-woo-delivery-card-body">
						<p class="tapsi-woo-delivery-date-tab-notice"><span class="dashicons dashicons-yes"></span><?php _e(' Settings Changed Successfully', 'woo-delivery'); ?></p>
	                    <form action="" method="post" id ="tapsi_delivery_date_form_submit">
	                        <?php wp_nonce_field('tapsi_woo_delivery_nonce'); ?>

	                    	<div class="tapsi-woo-delivery-form-group">
	                        	<span class="tapsi-woo-delivery-form-label"><?php _e('Enable Delivery Date', 'woo-delivery'); ?></span>
	                        	<p class="tapsi-woo-delivery-tooltip" tooltip="Enable Delivery Date input field in woocommerce order checkout page."><span class="dashicons dashicons-editor-help"></span></p>
							    <label class="tapsi-woo-delivery-toogle-switch" for="tapsi_enable_delivery_date">
							       <input type="checkbox" name="tapsi_enable_delivery_date" id="tapsi_enable_delivery_date" <?php echo (isset($date_settings['enable_delivery_date']) && !empty($date_settings['enable_delivery_date'])) ? "checked" : "" ?>/>
							       <div class="tapsi-woo-delivery-toogle-slider tapsi-woo-delivery-toogle-round"></div>
							    </label>
	                    	</div>
	                    	<div class="tapsi-woo-delivery-form-group">
	                        	<span class="tapsi-woo-delivery-form-label"><?php _e('Make Delivery Date Field Mandatory', 'woo-delivery'); ?></span>
	                        	<p class="tapsi-woo-delivery-tooltip" tooltip="Make Delivery Date input field mandatory in woocommerce order checkout page. Default is optional."><span class="dashicons dashicons-editor-help"></span></p>
							    <label class="tapsi-woo-delivery-toogle-switch" for="tapsi_delivery_date_mandatory">
							       <input type="checkbox" name="tapsi_delivery_date_mandatory" id="tapsi_delivery_date_mandatory" <?php echo (isset($date_settings['delivery_date_mandatory']) && !empty($date_settings['delivery_date_mandatory'])) ? "checked" : "" ?>/>
							       <div class="tapsi-woo-delivery-toogle-slider tapsi-woo-delivery-toogle-round"></div>
							    </label>
	                    	</div>
	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_delivery_date_field_label"><?php _e('Delivery Date Field Label', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Delivery Date input field label and placeholder. Default is Delivery Date."><span class="dashicons dashicons-editor-help"></span></p>
	                        	<input id="tapsi_delivery_date_field_label" name="tapsi_delivery_date_field_label" type="text" class="tapsi-woo-delivery-input-field" value="<?php echo (isset($date_settings['field_label']) && !empty($date_settings['field_label'])) ? esc_attr($date_settings['field_label']) : "" ?>" placeholder="" autocomplete="off"/>
	                    	</div>

	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_delivery_date_selectable_date"><?php _e('Allow Delivery in Next Available Days', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="User can only select the number of date from calander that is specified Here. Other dates are disabled. Only numerical value is excepted. Default is 365 days."><span class="dashicons dashicons-editor-help"></span></p>
	                        	<input onkeyup="if(!Number.isInteger(Number(this.value)) || this.value < 1) this.value = null;" id="tapsi_delivery_date_selectable_date" name="tapsi_delivery_date_selectable_date" type="number" class="tapsi-woo-delivery-number-field" value="<?php echo (isset($date_settings['selectable_date']) && !empty($date_settings['selectable_date'])) ? stripslashes(esc_attr($date_settings['selectable_date'])) : ""; ?>" placeholder="" autocomplete="off"/>
	                    	</div>

	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_delivery_date_week_starts_from"><?php _e('Week Starts From', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Delivery Date's calendar will start from the day that is selected Here. Default is Sunday."><span class="dashicons dashicons-editor-help"></span></p>
	                    		<select class="tapsi-woo-delivery-select-field" name="tapsi_delivery_date_week_starts_from">
	                    	...
	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_delivery_date_format"><?php _e('Delivery Date Format', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Date format that is used in everywhere which is available by this plugin. Default is F j, Y ( ex. March 6, 2011 )."><span class="dashicons dashicons-editor-help"></span></p>
	                    		<select class="tapsi-woo-delivery-select-field" name="tapsi_delivery_date_format">
	                    	...
	                    	<div class="tapsi-woo-delivery-form-group">
	                        	<span class="tapsi-woo-delivery-form-label"><?php _e('Auto Select 1st Available Date', 'woo-delivery'); ?></span>
	                        	<p class="tapsi-woo-delivery-tooltip" tooltip="Enable the option if you want to select the first available date automatically and shown in the delivery date field. Default is disable."><span class="dashicons dashicons-editor-help"></span></p>
							    <label class="tapsi-woo-delivery-toogle-switch" for="tapsi_auto_select_first_date">
							       <input type="checkbox" name="tapsi_auto_select_first_date" id="tapsi_auto_select_first_date" <?php echo (isset($date_settings['auto_select_first_date']) && !empty($date_settings['auto_select_first_date'])) ? "checked" : "" ?>/>
							       <div class="tapsi-woo-delivery-toogle-slider tapsi-woo-delivery-toogle-round"></div>
							    </label>
	                    	</div>
	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label tapsi-woo-delivery-checkbox-label" for="tapsi_delivery_date_delivery_days"><?php _e('Delivery Days', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip tapsi-woo-delivery-checkbox-tooltip" tooltip="Delivery is only available in those days that are checked. Other dates corresponding to the unchecked days are disabled in the calendar."><span class="dashicons dashicons-editor-help"></span></p>
	                    		<div id="tapsi_delivery_date_delivery_days" style="display:inline-block">
	                    		<input type="checkbox" name="tapsi_delivery_date_delivery_days[]" value="6" <?php echo in_array("6",$selected_delivery_day) ? "checked" : "";?>><label class="tapsi-woo-delivery-checkbox-field-text">Saturday</label><br/>
								<input type="checkbox" name="tapsi_delivery_date_delivery_days[]" value="0" <?php echo in_array("0",$selected_delivery_day) ? "checked" : "";?>><label class="tapsi-woo-delivery-checkbox-field-text">Sunday</label><br/>
								<input type="checkbox" name="tapsi_delivery_date_delivery_days[]" value="1" <?php echo in_array("1",$selected_delivery_day) ? "checked" : "";?>><label class="tapsi-woo-delivery-checkbox-field-text">Monday</label><br/>
								<input type="checkbox" name="tapsi_delivery_date_delivery_days[]" value="2" <?php echo in_array("2",$selected_delivery_day) ? "checked" : "";?>><label class="tapsi-woo-delivery-checkbox-field-text">Tuesday</label><br/>
								<input type="checkbox" name="tapsi_delivery_date_delivery_days[]" value="3" <?php echo in_array("3",$selected_delivery_day) ? "checked" : "";?>><label class="tapsi-woo-delivery-checkbox-field-text">Wednesday</label><br/>
								<input type="checkbox" name="tapsi_delivery_date_delivery_days[]" value="4" <?php echo in_array("4",$selected_delivery_day) ? "checked" : "";?>><label class="tapsi-woo-delivery-checkbox-field-text">Thursday</label><br/>
								<input type="checkbox" name="tapsi_delivery_date_delivery_days[]" value="5" <?php echo in_array("5",$selected_delivery_day) ? "checked" : "";?>><label class="tapsi-woo-delivery-checkbox-field-text">Friday</label><br/>
								</div>
	                    	</div>

	                        <input class="tapsi-woo-delivery-submit-btn" type="submit" name="tapsi_delivery_date_form_submit" value="<?php _e('Save Changes', 'woo-delivery'); ?>" />
			...
			<div data-tab="tab4" class="tapsi-woo-delivery-tabcontent">
				<div class="tapsi-woo-delivery-card">
					...
					<div class="tapsi-woo-delivery-card-body">
						<p class="tapsi-woo-delivery-pickup-date-tab-notice"><span class="dashicons dashicons-yes"></span><?php _e(' Settings Changed Successfully', 'woo-delivery'); ?></p>
	                    <form action="" method="post" id ="tapsi_delivery_pickup_date_form_submit">
	                        <?php wp_nonce_field('tapsi_woo_delivery_nonce'); ?>

	                    	<div class="tapsi-woo-delivery-form-group">
	                        	<span class="tapsi-woo-delivery-form-label"><?php _e('Enable Pickup Date', 'woo-delivery'); ?></span>
	                        	<p class="tapsi-woo-delivery-tooltip" tooltip="Enable Pickup Date input field in woocommerce order checkout page."><span class="dashicons dashicons-editor-help"></span></p>
							    <label class="tapsi-woo-delivery-toogle-switch" for="tapsi_enable_pickup_date">
							       <input type="checkbox" name="tapsi_enable_pickup_date" id="tapsi_enable_pickup_date" <?php echo (isset($pickup_date_settings['enable_pickup_date']) && !empty($pickup_date_settings['enable_pickup_date'])) ? "checked" : "" ?>/>
							       <div class="tapsi-woo-delivery-toogle-slider tapsi-woo-delivery-toogle-round"></div>
							    </label>
	                    	</div>
	                    	<div class="tapsi-woo-delivery-form-group">
	                        	<span class="tapsi-woo-delivery-form-label"><?php _e('Make Pickup Date Field Mandatory', 'woo-delivery'); ?></span>
	                        	<p class="tapsi-woo-delivery-tooltip" tooltip="Make Pickup Date input field mandatory in woocommerce order checkout page. Default is optional."><span class="dashicons dashicons-editor-help"></span></p>
							    <label class="tapsi-woo-delivery-toogle-switch" for="tapsi_pickup_date_mandatory">
							       <input type="checkbox" name="tapsi_pickup_date_mandatory" id="tapsi_pickup_date_mandatory" <?php echo (isset($pickup_date_settings['pickup_date_mandatory']) && !empty($pickup_date_settings['pickup_date_mandatory'])) ? "checked" : "" ?>/>
							       <div class="tapsi-woo-delivery-toogle-slider tapsi-woo-delivery-toogle-round"></div>
							    </label>
	                    	</div>

	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_pickup_date_field_label"><?php _e('Pickup Date Field Label', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Pickup Date input field heading. Default is Pickup Date."><span class="dashicons dashicons-editor-help"></span></p>
	                        	<input id="tapsi_pickup_date_field_label" name="tapsi_pickup_date_field_label" type="text" class="tapsi-woo-delivery-input-field" value="<?php echo (isset($pickup_date_settings['pickup_field_label']) && !empty($pickup_date_settings['pickup_field_label'])) ? stripslashes(esc_attr($pickup_date_settings['pickup_field_label'])) : "" ?>" placeholder="" autocomplete="off"/>
	                    	</div>

	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_pickup_date_selectable_date"><?php _e('Allow Pickup in Next Available Days', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="User can only select the number of date from calander that is specified Here. Other dates are disabled. Only numerical value is excepted. Default is 365 days."><span class="dashicons dashicons-editor-help"></span></p>
	                        	<input onkeyup="if(!Number.isInteger(Number(this.value)) || this.value < 1) this.value = null;" id="tapsi_pickup_date_selectable_date" name="tapsi_pickup_date_selectable_date" type="number" class="tapsi-woo-delivery-number-field" value="<?php echo (isset($pickup_date_settings['selectable_date']) && !empty($pickup_date_settings['selectable_date'])) ? stripslashes(esc_attr($pickup_date_settings['selectable_date'])) : "" ?>" placeholder="" autocomplete="off"/>
	                    	</div>

	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_pickup_date_week_starts_from"><?php _e('Week Starts From', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Pickup Date's calendar will start from the day that is selected Here. Default is Sunday."><span class="dashicons dashicons-editor-help"></span></p>
	                    		<select class="tapsi-woo-delivery-select-field" name="tapsi_pickup_date_week_starts_from">
	                    	...
	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_pickup_date_format"><?php _e('Pickup Date Format', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Date format that is used in everywhere which is available by this plugin. Default is F j, Y ( ex. March 6, 2011 )."><span class="dashicons dashicons-editor-help"></span></p>
	                    		<select class="tapsi-woo-delivery-select-field" name="tapsi_pickup_date_format">
	                    	...
	                    	<div class="tapsi-woo-delivery-form-group">
	                        	<span class="tapsi-woo-delivery-form-label"><?php _e('Auto Select 1st Available Date', 'woo-delivery'); ?></span>
	                        	<p class="tapsi-woo-delivery-tooltip" tooltip="Enable the option if you want to select the first available date automatically and shown in the pickup date field. Default is disable."><span class="dashicons dashicons-editor-help"></span></p>
							    <label class="tapsi-woo-delivery-toogle-switch" for="tapsi_auto_select_first_pickup_date">
							       <input type="checkbox" name="tapsi_auto_select_first_pickup_date" id="tapsi_auto_select_first_pickup_date" <?php echo (isset($pickup_date_settings['auto_select_first_pickup_date']) && !empty($pickup_date_settings['auto_select_first_pickup_date'])) ? "checked" : "" ?>/>
							       <div class="tapsi-woo-delivery-toogle-slider tapsi-woo-delivery-toogle-round"></div>
							    </label>
	                    	</div>

	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label tapsi-woo-delivery-checkbox-label" for="tapsi_pickup_date_delivery_days"><?php _e('Pickup Days', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip tapsi-woo-delivery-checkbox-tooltip" tooltip="Pickup is only available in those days that are checked. Other dates corresponding to the unchecked days are disabled in the calendar."><span class="dashicons dashicons-editor-help"></span></p>
	                    		<div id="tapsi_pickup_date_delivery_days" style="display:inline-block">
	                    		<input type="checkbox" name="tapsi_pickup_date_delivery_days[]" value="6" <?php echo in_array("6",$selected_pickup_day) ? "checked" : "";?>><label class="tapsi-woo-delivery-checkbox-field-text">Saturday</label><br/>
								<input type="checkbox" name="tapsi_pickup_date_delivery_days[]" value="0" <?php echo in_array("0",$selected_pickup_day) ? "checked" : "";?>><label class="tapsi-woo-delivery-checkbox-field-text">Sunday</label><br/>
								<input type="checkbox" name="tapsi_pickup_date_delivery_days[]" value="1" <?php echo in_array("1",$selected_pickup_day) ? "checked" : "";?>><label class="tapsi-woo-delivery-checkbox-field-text">Monday</label><br/>
								<input type="checkbox" name="tapsi_pickup_date_delivery_days[]" value="2" <?php echo in_array("2",$selected_pickup_day) ? "checked" : "";?>><label class="tapsi-woo-delivery-checkbox-field-text">Tuesday</label><br/>
								<input type="checkbox" name="tapsi_pickup_date_delivery_days[]" value="3" <?php echo in_array("3",$selected_pickup_day) ? "checked" : "";?>><label class="tapsi-woo-delivery-checkbox-field-text">Wednesday</label><br/>
								<input type="checkbox" name="tapsi_pickup_date_delivery_days[]" value="4" <?php echo in_array("4",$selected_pickup_day) ? "checked" : "";?>><label class="tapsi-woo-delivery-checkbox-field-text">Thursday</label><br/>
								<input type="checkbox" name="tapsi_pickup_date_delivery_days[]" value="5" <?php echo in_array("5",$selected_pickup_day) ? "checked" : "";?>><label class="tapsi-woo-delivery-checkbox-field-text">Friday</label><br/>
								</div>
	                    	</div>

	                        <input class="tapsi-woo-delivery-submit-btn" type="submit" name="tapsi_delivery_pickup_date_form_submit" value="<?php _e('Save Changes', 'woo-delivery'); ?>" />
			...
			<div data-tab="tab5" class="tapsi-woo-delivery-tabcontent">
				<div class="tapsi-woo-delivery-card">
					...
					<div class="tapsi-woo-delivery-card-body">
						<p class="tapsi-woo-delivery-date-tab-offdays-notice"></p>
						<input class="tapsi-woo-delivery-add-year-btn" type="button" value="<?php _e('Add New Year', 'woo-delivery'); ?>">
	                    <form action="" method="post" id ="tapsi_delivery_date_offdays_form_submit">
	                        <?php wp_nonce_field('tapsi_woo_delivery_nonce'); ?>
	                        <div id="tapsi-woo-delivery-offdays" class="tapsi-woo-delivery-offdays">
							    
	                        	<?php
	                        		$month_array = ['january','february','march','april','may','june','july','august','september','october','november','december'];
									$offdays_html = "";
									$offdays_years = get_option('tapsi_woo_delivery_date_settings');
									if(isset($offdays_years['off_days']) && !empty($offdays_years['off_days'])) {
										foreach($offdays_years['off_days'] as $year=>$months) {
											
											$offdays_html .= '<div class="tapsi-woo-delivery-add-year-html tapsi-woo-delivery-form-group">';
											if(array_keys($offdays_years['off_days'])[0] == $year) {
												$offdays_html .= '<img class="tapsi-arrow" src="'. TAPSI_WOO_DELIVERY_URL .'/admin/images/arrow.png" alt="" style="width: 20px;vertical-align: top;margin-top: 12px;margin-right: 15px;">';	

											} else {
												$offdays_html .= '<button class="tapsi-offdays-year-remove"><span class="dashicons dashicons-trash"></span></button>';
											}
											
											$offdays_html .= '<input style="width:125px" class="tapsi-woo-delivery-input-field tapsi_woo_delivery_offdays_year" maxlength="4" type="text" value="'.$year.'" placeholder="'.__('Year (ex. 2019)', 'woo-delivery').'" style="vertical-align:top;" autocomplete="off" name="tapsi_woo_delivery_offdays_year_'.$year.'">';
											$offdays_html .= '<div style="display:inline-block;" class="tapsi_woo_delivery_offdays_another_month tapsi_woo_delivery_offdays_another_month_'.$year.'">';
											foreach($months as $month=>$date) {
												$offdays_html .= '<div class="tapsi_woo_delivery_offdays_add_another_month">';
												$offdays_html .= '<select style="width:125px!important" class="tapsi-woo-delivery-select-field" name="tapsi_woo_delivery_offdays_month_'.$year.'[]">';
												...
												$offdays_html .= '</select>';
												$offdays_html .= '<input id="tapsi_woo_delivery_offdays_dates" type="text" class="tapsi-woo-delivery-input-field" value="'.$date.'" placeholder="'.__('Comma(,) Separeted Date', 'woo-delivery').'" style="width:200px;vertical-align:top;" autocomplete="off" name="tapsi_woo_delivery_offdays_dates_'.$month.'_'.$year.'">';
												if(array_keys($months)[0] != $month) {
													
													$offdays_html .= '<button class="tapsi-offdays-month-remove"><span class="dashicons dashicons-trash"></span></button>';
												}
												$offdays_html .= '</div>';
											}
											$offdays_html .= '</div>';
											$offdays_html .= '<br>
												    	  <span style="position:relative;left:35%">
														    <input class="tapsi-woo-delivery-add-month-btn" type="button" value="'.__("Add Month", "woo-delivery").'">
														    <div class="tapsi-woo-delivery-dummy-btn" style="position:absolute; left:0; right:0; top:0; bottom:0; cursor: pointer;"></div>
														  </span>';
							    ...
							    <div class="tapsi-woo-delivery-add-year-html tapsi-woo-delivery-form-group">
							    	<img class="tapsi-arrow" src="<?php echo TAPSI_WOO_DELIVERY_URL ?>/admin/images/arrow.png" alt="" style="width: 20px;vertical-align: top;margin-top: 12px;margin-right: 15px;">
							        <input style="width:125px" class="tapsi-woo-delivery-input-field tapsi_woo_delivery_offdays_year" maxlength="4" type="text" value="<?php  ?>" placeholder="<?php _e('Year (ex. 2019)', 'woo-delivery'); ?>" style="vertical-align:top;" autocomplete="off"/>
							        <div class="tapsi_woo_delivery_offdays_another_month" style="display:inline-block;">
								        <div class="tapsi_woo_delivery_offdays_add_another_month">
									        <select style="width:125px!important" class="tapsi-woo-delivery-select-field" disabled="disabled">
									        ...
									        <input style="width:200px" id="tapsi_woo_delivery_offdays_dates" type="text" class="tapsi-woo-delivery-input-field" value="<?php  ?>" placeholder="<?php _e('Comma(,) Separeted Date', 'woo-delivery'); ?>" style="vertical-align:top;" autocomplete="off" disabled="disabled"/>
								    	</div>
							    	</div>
							    	<br/>
							    	<span style="position:relative;left:18%">
									  <input class="tapsi-woo-delivery-add-month-btn" type="button" value="<?php _e('Add Month', 'woo-delivery'); ?>" disabled="disabled">
									  <div class="tapsi-woo-delivery-dummy-btn" style="position:absolute; left:0; right:0; top:0; bottom:0; cursor: pointer;"></div>
									</span>
	                        ...
	                        <input class="tapsi-woo-delivery-submit-btn" type="submit" name="tapsi_delivery_date_offdays_form_submit" value="<?php _e('Save Changes', 'woo-delivery'); ?>" />
			...
			<div data-tab="tab6" class="tapsi-woo-delivery-tabcontent">
				<div class="tapsi-woo-delivery-card">
					...
					<div class="tapsi-woo-delivery-card-body">
						<p class="tapsi-woo-delivery-time-tab-notice"><span class="dashicons dashicons-yes"></span><?php _e(' Settings Changed Successfully', 'woo-delivery'); ?></p>
	                    <form action="" method="post" id ="tapsi_delivery_time_form_submit">
	                        <?php wp_nonce_field('tapsi_woo_delivery_nonce'); ?>

	                    	<div class="tapsi-woo-delivery-form-group">
	                        	<span class="tapsi-woo-delivery-form-label"><?php _e('Enable Delivery Time', 'woo-delivery'); ?></span>
	                        	<p class="tapsi-woo-delivery-tooltip" tooltip="Enable Delivery Time select field in woocommerce order checkout page."><span class="dashicons dashicons-editor-help"></span></p>
							    <label class="tapsi-woo-delivery-toogle-switch" for="tapsi_enable_delivery_time">
							       <input type="checkbox" name="tapsi_enable_delivery_time" id="tapsi_enable_delivery_time" <?php echo (isset($time_settings['enable_delivery_time']) && !empty($time_settings['enable_delivery_time'])) ? "checked" : "" ?>/>
							       <div class="tapsi-woo-delivery-toogle-slider tapsi-woo-delivery-toogle-round"></div>
							    </label>
	                    	</div>
	                    	<div class="tapsi-woo-delivery-form-group">
	                        	<span class="tapsi-woo-delivery-form-label"><?php _e('Make Delivery Time Field Mandatory', 'woo-delivery'); ?></span>
	                        	<p class="tapsi-woo-delivery-tooltip" tooltip="Make Delivery Time select field mandatory in woocommerce order checkout page. Default is optional."><span class="dashicons dashicons-editor-help"></span></p>
							    <label class="tapsi-woo-delivery-toogle-switch" for="tapsi_delivery_time_mandatory">
							       <input type="checkbox" name="tapsi_delivery_time_mandatory" id="tapsi_delivery_time_mandatory" <?php echo (isset($time_settings['delivery_time_mandatory']) && !empty($time_settings['delivery_time_mandatory'])) ? "checked" : "" ?>/>
							       <div class="tapsi-woo-delivery-toogle-slider tapsi-woo-delivery-toogle-round"></div>
							    </label>
	                    	</div>
	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_delivery_time_field_label"><?php _e('Delivery Time Field Label', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Delivery Time select field label and placeholder. Default is Delivery Time."><span class="dashicons dashicons-editor-help"></span></p>
	                        	<input id="tapsi_delivery_time_field_label" name="tapsi_delivery_time_field_label" type="text" class="tapsi-woo-delivery-input-field" value="<?php echo (isset($time_settings['field_label']) && !empty($time_settings['field_label'])) ? esc_attr($time_settings['field_label']) : "" ?>" placeholder="" autocomplete="off"/>
	                    	</div>
	                    	<?php 
                    			$start_hour = "";
            					$start_min = "";
                    		...
                    		?>
	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_delivery_time_slot_starts"><?php _e('Time Slot Starts From', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Delivery Time starts from the time that is specified here. Only numerical value is accepted."><span class="dashicons dashicons-editor-help"></span></p>
	                    		<div id="tapsi_delivery_time_slot_starts" class="tapsi_delivery_time_slot_starts">
	                    			
	                        	<input name="tapsi_delivery_time_slot_starts_hour" type="number" class="tapsi-woo-delivery-number-field" max="12" min="1" onkeyup="if(!Number.isInteger(Number(this.value)) || this.value > 12 || this.value < 1) this.value = null;" value="<?php echo $start_hour; ?>" placeholder="Hour" autocomplete="off"/>
	                        	<input name="tapsi_delivery_time_slot_starts_min" type="number" class="tapsi-woo-delivery-number-field" max="59" min="0" onkeyup="if(!Number.isInteger(Number(this.value)) || this.value > 59 || this.value < 0) this.value = null;" value="<?php echo $start_min; ?>" placeholder="Minute" autocomplete="off"/>
	                        	<select class="tapsi-woo-delivery-select-field" name="tapsi_delivery_time_slot_starts_format">
                    		...
                    		?>
	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_delivery_time_slot_ends"><?php _e('Time Slot Ends At', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Delivery Time ends at the time that is specified here. Only numerical value is accepted."><span class="dashicons dashicons-editor-help"></span></p>
	                    		<div id="tapsi_delivery_time_slot_ends" class="tapsi_delivery_time_slot_ends">
	                        	<input name="tapsi_delivery_time_slot_ends_hour" type="number" class="tapsi-woo-delivery-number-field" max="12" min="1" onkeyup="if(!Number.isInteger(Number(this.value)) || this.value > 12 || this.value < 1) this.value = null;" value="<?php echo $end_hour; ?>" placeholder="Hour" autocomplete="off"/>
	                        	<input name="tapsi_delivery_time_slot_ends_min" type="number" class="tapsi-woo-delivery-number-field" max="59" min="0" onkeyup="if(!Number.isInteger(Number(this.value)) || this.value > 59 || this.value < 0) this.value = null;" value="<?php echo $end_min; ?>" placeholder="Minute" autocomplete="off"/>
	                        	<select class="tapsi-woo-delivery-select-field" name="tapsi_delivery_time_slot_ends_format">
									<option value="am" <?php selected($end_format,"am",true); ?>>AM</option>
									<option value="pm" <?php selected($end_format,"pm",true); ?>>PM</option>
								</select>
	                        	</div>
	                        	<p class="tapsi_end_time_greater_notice"><?php _e('End Time Must after Start Time', 'woo-delivery'); ?></p>
	                    	</div>
	                    	<?php
	                    		$duration = ""; 
	                    		$identity = "min";
	                    	...
	                    	?>
	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_delivery_time_slot_duration"><?php _e('Each Time Slot Duration', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Each delivery time slot duration that is specified here. Only numerical value is accepted. Default is 3 hours."><span class="dashicons dashicons-editor-help"></span></p>
	                    		<div id="tapsi_delivery_time_slot_duration" class="tapsi_delivery_time_slot_duration">
	                        	<input name="tapsi_delivery_time_slot_duration_time" type="number" min="1" onkeyup="if(!Number.isInteger(Number(this.value)) || this.value < 1) this.value = null;" class="tapsi-woo-delivery-number-field" value="<?php echo $duration; ?>" placeholder="" autocomplete="off"/>
	                        	<select class="tapsi-woo-delivery-select-field" name="tapsi_delivery_time_slot_duration_format">
	                    	...
	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_delivery_time_maximum_order"><?php _e('Maximum Order Per Time Slot', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Each time slot take maximum number of orders that is specified here. After reaching the maximum order, the time slot is disabled automaticaly. Only numerical value is accepted. Blank this field or 0 value means each time slot takes unlimited order."><span class="dashicons dashicons-editor-help"></span></p>
	                        	<input id="tapsi_delivery_time_maximum_order" name="tapsi_delivery_time_maximum_order" type="number" class="tapsi-woo-delivery-number-field" min="1" onkeyup="if(!Number.isInteger(Number(this.value)) || this.value < 1) this.value = null;" value="<?php echo (isset($time_settings['max_order_per_slot']) && !empty($time_settings['max_order_per_slot'])) ? stripslashes(esc_attr($time_settings['max_order_per_slot'])) : ""; ?>" placeholder="" autocomplete="off"/>
	                    	</div>

	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_delivery_time_format"><?php _e('Delivery Time format', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Time format that is used in everywhere which is available by this plugin. Default is 12 Hours."><span class="dashicons dashicons-editor-help"></span></p>
	                    		<select class="tapsi-woo-delivery-select-field" name="tapsi_delivery_time_format">
	                    	...
	                    	<div class="tapsi-woo-delivery-form-group">
	                        	<span class="tapsi-woo-delivery-form-label"><?php _e('Disable Current Time Slot', 'woo-delivery'); ?></span>
	                        	<p class="tapsi-woo-delivery-tooltip" tooltip="Make the time slot disabled that has the current time. In default, the time slot isn't disabled that has the current time."><span class="dashicons dashicons-editor-help"></span></p>
							    <label class="tapsi-woo-delivery-toogle-switch" for="tapsi_delivery_time_disable_current_time_slot">
							       <input type="checkbox" name="tapsi_delivery_time_disable_current_time_slot" id="tapsi_delivery_time_disable_current_time_slot" <?php echo (isset($time_settings['disabled_current_time_slot']) && !empty($time_settings['disabled_current_time_slot'])) ? "checked" : "" ?>/>
							       <div class="tapsi-woo-delivery-toogle-slider tapsi-woo-delivery-toogle-round"></div>
							    </label>
	                    	</div>

	                    	<div class="tapsi-woo-delivery-form-group">
	                        	<span class="tapsi-woo-delivery-form-label"><?php _e('Auto Select 1st Available Time', 'woo-delivery'); ?></span>
	                        	<p class="tapsi-woo-delivery-tooltip" tooltip="Enable the option if you want to select the first available time based on date automatically and shown in the delivery time field. Default is disable."><span class="dashicons dashicons-editor-help"></span></p>
							    <label class="tapsi-woo-delivery-toogle-switch" for="tapsi_auto_select_first_time">
							       <input type="checkbox" name="tapsi_auto_select_first_time" id="tapsi_auto_select_first_time" <?php echo (isset(get_option('tapsi_woo_delivery_time_settings')['auto_select_first_time']) && !empty(get_option('tapsi_woo_delivery_time_settings')['auto_select_first_time'])) ? "checked" : "" ?>/>
							       <div class="tapsi-woo-delivery-toogle-slider tapsi-woo-delivery-toogle-round"></div>
							    </label>
	                    	</div>


	                        <input class="tapsi-woo-delivery-submit-btn" type="submit" name="tapsi_delivery_time_form_submit" value="<?php _e('Save Changes', 'woo-delivery'); ?>" />
			...
			<div data-tab="tab7" class="tapsi-woo-delivery-tabcontent">
				<div class="tapsi-woo-delivery-card">
					<p class="tapsi-woo-delivery-card-header"><?php _e('General Pickup Time Settings', 'woo-delivery'); ?></p>
					<div class="tapsi-woo-delivery-card-body">
						<p class="tapsi-woo-delivery-pickup-time-tab-notice"><span class="dashicons dashicons-yes"></span><?php _e(' Settings Changed Successfully', 'woo-delivery'); ?></p>
	                    <form action="" method="post" id ="tapsi_pickup_time_form_submit">
	                        <?php wp_nonce_field('tapsi_woo_delivery_nonce'); ?>

	                    	<div class="tapsi-woo-delivery-form-group">
	                        	<span class="tapsi-woo-delivery-form-label"><?php _e('Enable Pickup Time', 'woo-delivery'); ?></span>
	                        	<p class="tapsi-woo-delivery-tooltip" tooltip="Enable Pickup Time select field in woocommerce order checkout page."><span class="dashicons dashicons-editor-help"></span></p>
							    <label class="tapsi-woo-delivery-toogle-switch" for="tapsi_enable_pickup_time">
							       <input type="checkbox" name="tapsi_enable_pickup_time" id="tapsi_enable_pickup_time" <?php echo (isset($pickup_time_settings['enable_pickup_time']) && !empty($pickup_time_settings['enable_pickup_time'])) ? "checked" : "" ?>/>
							       <div class="tapsi-woo-delivery-toogle-slider tapsi-woo-delivery-toogle-round"></div>
							    </label>
	                    	</div>
	                    	<div class="tapsi-woo-delivery-form-group">
	                        	<span class="tapsi-woo-delivery-form-label"><?php _e('Make Pickup Time Field Mandatory', 'woo-delivery'); ?></span>
	                        	<p class="tapsi-woo-delivery-tooltip" tooltip="Make Pickup Time select field mandatory in woocommerce order checkout page. Default is optional."><span class="dashicons dashicons-editor-help"></span></p>
							    <label class="tapsi-woo-delivery-toogle-switch" for="tapsi_pickup_time_mandatory">
							       <input type="checkbox" name="tapsi_pickup_time_mandatory" id="tapsi_pickup_time_mandatory" <?php echo (isset($pickup_time_settings['pickup_time_mandatory']) && !empty($pickup_time_settings['pickup_time_mandatory'])) ? "checked" : "" ?>/>
							       <div class="tapsi-woo-delivery-toogle-slider tapsi-woo-delivery-toogle-round"></div>
							    </label>
	                    	</div>
	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_pickup_time_field_label"><?php _e('Pickup Time Field Label', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Pickup Time select field heading. Default is Pickup Time."><span class="dashicons dashicons-editor-help"></span></p>
	                        	<input id="tapsi_pickup_time_field_label" name="tapsi_pickup_time_field_label" type="text" class="tapsi-woo-delivery-input-field" value="<?php echo (isset($pickup_time_settings['field_label']) && !empty($pickup_time_settings['field_label'])) ? stripslashes(esc_attr($pickup_time_settings['field_label'])) : "" ?>" placeholder="" autocomplete="off"/>
	                    	</div>
	                    	<?php 
                    			$pickup_start_hour = "";
            					$pickup_start_min = "";
                    		...
                    		?>
	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_pickup_time_slot_starts"><?php _e('Pickup Time Slot Starts From', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Pickup Time starts from the time that is specified here. Only numerical value is accepted."><span class="dashicons dashicons-editor-help"></span></p>
	                    		<div id="tapsi_pickup_time_slot_starts" class="tapsi_pickup_time_slot_starts">
	                    			
	                        	<input name="tapsi_pickup_time_slot_starts_hour" type="number" class="tapsi-woo-delivery-number-field" max="12" min="1" onkeyup="if(!Number.isInteger(Number(this.value)) || this.value > 12 || this.value < 1) this.value = null;" value="<?php echo $pickup_start_hour; ?>" placeholder="Hour" autocomplete="off"/>
	                        	<input name="tapsi_pickup_time_slot_starts_min" type="number" class="tapsi-woo-delivery-number-field" max="59" min="0" onkeyup="if(!Number.isInteger(Number(this.value)) || this.value > 59 || this.value < 0) this.value = null;" value="<?php echo $pickup_start_min; ?>" placeholder="Minute" autocomplete="off"/>
	                        	<select class="tapsi-woo-delivery-select-field" name="tapsi_pickup_time_slot_starts_format">
                    		...
                    		?>
	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_delivery_time_slot_ends"><?php _e('Pickup Time Slot Ends At', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Pickup Time ends at the time that is specified here. Only numerical value is accepted."><span class="dashicons dashicons-editor-help"></span></p>
	                    		<div id="tapsi_pickup_time_slot_ends" class="tapsi_pickup_time_slot_ends">
	                        	<input name="tapsi_pickup_time_slot_ends_hour" type="number" class="tapsi-woo-delivery-number-field" max="12" min="1" onkeyup="if(!Number.isInteger(Number(this.value)) || this.value > 12 || this.value < 1) this.value = null;" value="<?php echo $pickup_end_hour; ?>" placeholder="Hour" autocomplete="off"/>
	                        	<input name="tapsi_pickup_time_slot_ends_min" type="number" class="tapsi-woo-delivery-number-field" max="59" min="0" onkeyup="if(!Number.isInteger(Number(this.value)) || this.value > 59 || this.value < 0) this.value = null;" value="<?php echo $pickup_end_min; ?>" placeholder="Minute" autocomplete="off"/>
	                        	<select class="tapsi-woo-delivery-select-field" name="tapsi_pickup_time_slot_ends_format">
	                        	...
	                        	<!-- <p class="tapsi_pickup_end_time_greater_notice">End Time Must after Start Time</p> -->
	                    	</div>
	                    	<?php
	                    		$pickup_duration = ""; 
	                    		$pickup_identity = "min";
	                    	...
	                    	?>
	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_pickup_time_slot_duration"><?php _e('Each Pickup Time Slot Duration', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Each pickup time slot duration that is specified here. Only numerical value is accepted."><span class="dashicons dashicons-editor-help"></span></p>
	                    		<div id="tapsi_pickup_time_slot_duration" class="tapsi_pickup_time_slot_duration">
	                        	<input name="tapsi_pickup_time_slot_duration_time" type="number" min="1" onkeyup="if(!Number.isInteger(Number(this.value)) || this.value < 1) this.value = null;" class="tapsi-woo-delivery-number-field" value="<?php echo $pickup_duration; ?>" placeholder="" autocomplete="off"/>
	                        	<select class="tapsi-woo-delivery-select-field" name="tapsi_pickup_time_slot_duration_format">
	                    	...
	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_pickup_time_maximum_order"><?php _e('Maximum Pickup Per Time Slot', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Each time slot take maximum number of pickups that is specified here. After reaching the maximum pickup, the time slot is disabled automaticaly. Only numerical value is accepted. Blank this field means each time slot takes unlimited pickup."><span class="dashicons dashicons-editor-help"></span></p>
	                        	<input id="tapsi_pickup_time_maximum_order" name="tapsi_pickup_time_maximum_order" type="number" class="tapsi-woo-delivery-number-field" min="1" onkeyup="if(!Number.isInteger(Number(this.value)) || this.value < 1) this.value = null;" value="<?php echo (isset($pickup_time_settings['max_pickup_per_slot']) && !empty($pickup_time_settings['max_pickup_per_slot'])) ? stripslashes(esc_attr($pickup_time_settings['max_pickup_per_slot'])) : ""; ?>" placeholder="" autocomplete="off"/>
	                    	</div>

	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_pickup_time_format"><?php _e('Pickup Time format', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Time format that is used in everywhere which is available by this plugin. Default is 12 Hours."><span class="dashicons dashicons-editor-help"></span></p>
	                    		<select class="tapsi-woo-delivery-select-field" name="tapsi_pickup_time_format">
	                    	...
	                    	<div class="tapsi-woo-delivery-form-group">
	                        	<span class="tapsi-woo-delivery-form-label"><?php _e('Disable Current Time Slot', 'woo-delivery'); ?></span>
	                        	<p class="tapsi-woo-delivery-tooltip" tooltip="Make the time slot disabled that has the current time. In default, the time slot isn't disabled that has the current time."><span class="dashicons dashicons-editor-help"></span></p>
							    <label class="tapsi-woo-delivery-toogle-switch" for="tapsi_pickup_time_disable_current_time_slot">
							       <input type="checkbox" name="tapsi_pickup_time_disable_current_time_slot" id="tapsi_pickup_time_disable_current_time_slot" <?php echo (isset($pickup_time_settings['disabled_current_pickup_time_slot']) && !empty($pickup_time_settings['disabled_current_pickup_time_slot'])) ? "checked" : "" ?>/>
							       <div class="tapsi-woo-delivery-toogle-slider tapsi-woo-delivery-toogle-round"></div>
							    </label>
	                    	</div>
	                    	<div class="tapsi-woo-delivery-form-group">
	                        	<span class="tapsi-woo-delivery-form-label"><?php _e('Auto Select 1st Available Time', 'woo-delivery'); ?></span>
	                        	<p class="tapsi-woo-delivery-tooltip" tooltip="Enable the option if you want to select the first available time based on date automatically and shown in the pickup time field. Default is disable."><span class="dashicons dashicons-editor-help"></span></p>
							    <label class="tapsi-woo-delivery-toogle-switch" for="tapsi_auto_select_first_pickup_time">
							       <input type="checkbox" name="tapsi_auto_select_first_pickup_time" id="tapsi_auto_select_first_pickup_time" <?php echo (isset(get_option('tapsi_woo_delivery_pickup_settings')['auto_select_first_time']) && !empty(get_option('tapsi_woo_delivery_pickup_settings')['auto_select_first_time'])) ? "checked" : "" ?>/>
							       <div class="tapsi-woo-delivery-toogle-slider tapsi-woo-delivery-toogle-round"></div>
							    </label>
	                    	</div>
	                        <input class="tapsi-woo-delivery-submit-btn" type="submit" name="tapsi_pickup_time_form_submit" value="<?php _e('Save Changes', 'woo-delivery'); ?>" />
			...
			<div data-tab="tab8" class="tapsi-woo-delivery-tabcontent">
				<div class="tapsi-woo-delivery-card">
					<p class="tapsi-woo-delivery-card-header"><?php _e('Localization', 'woo-delivery'); ?></p>
					<div class="tapsi-woo-delivery-card-body">
						<p class="tapsi-woo-delivery-localization-settings-notice"><span class="dashicons dashicons-yes"></span><?php _e(' Settings Changed Successfully', 'woo-delivery'); ?></p>
	                    <form action="" method="post" id ="tapsi_delivery_localization_settings_form_submit">
	                        <?php wp_nonce_field('tapsi_woo_delivery_nonce'); ?>

	                        <div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_woo_delivery_order_limit_notice"><?php _e('Maximum Delivery Limit Exceed', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Maximum Order Limit Notice. Default is Maximum Order Limit Exceed."><span class="dashicons dashicons-editor-help"></span></p>
	                        	<input id="tapsi_woo_delivery_order_limit_notice" name="tapsi_woo_delivery_order_limit_notice" type="text" class="tapsi-woo-delivery-input-field" value="<?php echo (isset(get_option('tapsi_woo_delivery_localization_settings')['order_limit_notice']) && !empty(get_option('tapsi_woo_delivery_localization_settings')['order_limit_notice'])) ? get_option('tapsi_woo_delivery_localization_settings')['order_limit_notice'] : "" ?>" placeholder="" autocomplete="off"/>
	                    	</div>
	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_woo_delivery_pickup_limit_notice"><?php _e('Maximum Pickup Limit Exceed', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Maximum Pickup Limit Notice. Default is Maximum Pickup Limit Exceed."><span class="dashicons dashicons-editor-help"></span></p>
	                        	<input id="tapsi_woo_delivery_pickup_limit_notice" name="tapsi_woo_delivery_pickup_limit_notice" type="text" class="tapsi-woo-delivery-input-field" value="<?php echo (isset(get_option('tapsi_woo_delivery_localization_settings')['pickup_limit_notice']) && !empty(get_option('tapsi_woo_delivery_localization_settings')['pickup_limit_notice'])) ? stripslashes(esc_attr(get_option('tapsi_woo_delivery_localization_settings')['pickup_limit_notice'])) : "" ?>" placeholder="" autocomplete="off"/>
	                    	</div>
	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_woo_delivery_delivery_details_text"><?php _e('Delivery Details', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Delivery Details text in order page, single order page, customer account page. Default is Delivery Details."><span class="dashicons dashicons-editor-help"></span></p>
	                        	<input id="tapsi_woo_delivery_delivery_details_text" name="tapsi_woo_delivery_delivery_details_text" type="text" class="tapsi-woo-delivery-input-field" value="<?php echo (isset(get_option('tapsi_woo_delivery_localization_settings')['delivery_details_text']) && !empty(get_option('tapsi_woo_delivery_localization_settings')['delivery_details_text'])) ? get_option('tapsi_woo_delivery_localization_settings')['delivery_details_text'] : "" ?>" placeholder="" autocomplete="off"/>
	                    	</div>

	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_woo_delivery_order_metabox_heading"><?php _e('Single Order Page Metabox Heading', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Single order page metabox heading text. Default is Delivery Date & Time."><span class="dashicons dashicons-editor-help"></span></p>
	                        	<input id="tapsi_woo_delivery_order_metabox_heading" name="tapsi_woo_delivery_order_metabox_heading" type="text" class="tapsi-woo-delivery-input-field" value="<?php echo (isset(get_option('tapsi_woo_delivery_localization_settings')['order_metabox_heading']) && !empty(get_option('tapsi_woo_delivery_localization_settings')['order_metabox_heading'])) ? get_option('tapsi_woo_delivery_localization_settings')['order_metabox_heading'] : "" ?>" placeholder="" autocomplete="off"/>
	                    	</div>
	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_woo_delivery_checkout_delivery_option_notice"><?php _e('Order Type Checkout Page Notice', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Notice if you make the order type field required but not given any value to the field. Default is Please Select Your Order Type."><span class="dashicons dashicons-editor-help"></span></p>
	                        	<input id="tapsi_woo_delivery_checkout_delivery_option_notice" name="tapsi_woo_delivery_checkout_delivery_option_notice" type="text" class="tapsi-woo-delivery-input-field" value="<?php echo (isset(get_option('tapsi_woo_delivery_localization_settings')['checkout_delivery_option_notice']) && !empty(get_option('tapsi_woo_delivery_localization_settings')['checkout_delivery_option_notice'])) ? get_option('tapsi_woo_delivery_localization_settings')['checkout_delivery_option_notice'] : "" ?>" placeholder="" autocomplete="off"/>
	                    	</div>
	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_woo_delivery_checkout_date_notice"><?php _e('Delivery Date Checkout Page Notice', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Notice if you make the delivery date field required but not given any value to the field. Default is Please Enter Delivery Date."><span class="dashicons dashicons-editor-help"></span></p>
	                        	<input id="tapsi_woo_delivery_checkout_date_notice" name="tapsi_woo_delivery_checkout_date_notice" type="text" class="tapsi-woo-delivery-input-field" value="<?php echo (isset(get_option('tapsi_woo_delivery_localization_settings')['checkout_date_notice']) && !empty(get_option('tapsi_woo_delivery_localization_settings')['checkout_date_notice'])) ? get_option('tapsi_woo_delivery_localization_settings')['checkout_date_notice'] : "" ?>" placeholder="" autocomplete="off"/>
	                    	</div>
	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_woo_delivery_checkout_pickup_date_notice"><?php _e('Pickup Date Checkout Page Notice', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Notice if you make the pickup date field required but not given any value to the field. Default is Please Enter Pickup Date."><span class="dashicons dashicons-editor-help"></span></p>
	                        	<input id="tapsi_woo_delivery_checkout_pickup_date_notice" name="tapsi_woo_delivery_checkout_pickup_date_notice" type="text" class="tapsi-woo-delivery-input-field" value="<?php echo (isset(get_option('tapsi_woo_delivery_localization_settings')['checkout_pickup_date_notice']) && !empty(get_option('tapsi_woo_delivery_localization_settings')['checkout_pickup_date_notice'])) ? stripslashes(esc_attr(get_option('tapsi_woo_delivery_localization_settings')['checkout_pickup_date_notice'])) : "" ?>" placeholder="" autocomplete="off"/>
	                    	</div>
	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_woo_delivery_checkout_time_notice"><?php _e('Delivery Time Checkout Page Notice', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Notice if you make the delivery time field required but not given any value to the field. Default is Please Enter Delivery Time."><span class="dashicons dashicons-editor-help"></span></p>
	                        	<input id="tapsi_woo_delivery_checkout_time_notice" name="tapsi_woo_delivery_checkout_time_notice" type="text" class="tapsi-woo-delivery-input-field" value="<?php echo (isset(get_option('tapsi_woo_delivery_localization_settings')['checkout_time_notice']) && !empty(get_option('tapsi_woo_delivery_localization_settings')['checkout_time_notice'])) ? get_option('tapsi_woo_delivery_localization_settings')['checkout_time_notice'] : "" ?>" placeholder="" autocomplete="off"/>
	                    	</div>
	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_woo_delivery_checkout_pickup_time_notice"><?php _e('Pickup Time Checkout Page Notice', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Notice if you make the pickup time field required but not given any value to the field. Default is Please Enter Pickup Time."><span class="dashicons dashicons-editor-help"></span></p>
	                        	<input id="tapsi_woo_delivery_checkout_pickup_time_notice" name="tapsi_woo_delivery_checkout_pickup_time_notice" type="text" class="tapsi-woo-delivery-input-field" value="<?php echo (isset(get_option('tapsi_woo_delivery_localization_settings')['checkout_pickup_time_notice']) && !empty(get_option('tapsi_woo_delivery_localization_settings')['checkout_pickup_time_notice'])) ? stripslashes(esc_attr(get_option('tapsi_woo_delivery_localization_settings')['checkout_pickup_time_notice'])) : "" ?>" placeholder="" autocomplete="off"/>
	                    	</div>
	                        <input class="tapsi-woo-delivery-submit-btn" type="submit" name="tapsi_delivery_localization_settings_form_submit" value="<?php _e('Save Changes', 'woo-delivery'); ?>" />
			...
			<div data-tab="tab9" class="tapsi-woo-delivery-tabcontent">
				<div class="tapsi-woo-delivery-card">
					<p class="tapsi-woo-delivery-card-header"><?php _e('Other Settings', 'woo-delivery'); ?></p>
					<div class="tapsi-woo-delivery-card-body">
						<p class="tapsi-woo-delivery-other-settings-notice"><span class="dashicons dashicons-yes"></span><?php _e(' Settings Changed Successfully', 'woo-delivery'); ?></p>
	                    <form action="" method="post" id ="tapsi_delivery_other_settings_form_submit">
	                        <?php wp_nonce_field('tapsi_woo_delivery_nonce'); ?>

	                        <div class="tapsi-woo-delivery-form-group">
	                        	<span class="tapsi-woo-delivery-form-label" style="display:unset!important"><?php _e('Enable Delivery Field For Virtual Or Downloadable Products', 'woo-delivery'); ?></span>
	                        	<p class="tapsi-woo-delivery-tooltip" tooltip="Enable the delivery fields if there is any virtual or downloadable products in the cart. Default is disable."><span class="dashicons dashicons-editor-help"></span></p>
							    <label class="tapsi-woo-delivery-toogle-switch" for="tapsi_disable_fields_for_downloadable_products">
							       <input type="checkbox" name="tapsi_disable_fields_for_downloadable_products" id="tapsi_disable_fields_for_downloadable_products" <?php echo (isset(get_option('tapsi_woo_delivery_other_settings')['disable_fields_for_downloadable_products']) && !empty(get_option('tapsi_woo_delivery_other_settings')['disable_fields_for_downloadable_products'])) ? "checked" : "" ?>/>
							       <div class="tapsi-woo-delivery-toogle-slider tapsi-woo-delivery-toogle-round"></div>
							    </label>
	                    	</div>

	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" for="tapsi_woo_delivery_delivery_heading_checkout" style="display:unset!important"><?php _e('Heading On The Checkout Page', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Checkout heading text of delivery section. Default is Delivery Information."><span class="dashicons dashicons-editor-help"></span></p>
	                        	<input id="tapsi_woo_delivery_delivery_heading_checkout" name="tapsi_woo_delivery_delivery_heading_checkout" type="text" class="tapsi-woo-delivery-input-field" value="<?php echo (isset($other_settings['delivery_heading_checkout']) && !empty($other_settings['delivery_heading_checkout'])) ? stripslashes(esc_attr($other_settings['delivery_heading_checkout'])) : "" ?>" placeholder="" autocomplete="off"/>
	                    	</div>

	                        <div class="tapsi-woo-delivery-form-group">
	                    		<label style="width:105px!important;" class="tapsi-woo-delivery-form-label" for="tapsi_delivery_time_format" style="display:unset!important"><?php _e('Field Position', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="Position of all the fields that are enabled by this plugin. Default is after order notes."><span class="dashicons dashicons-editor-help"></span></p>
	                    		<select class="tapsi-woo-delivery-select-field" name="tapsi_woo_delivery_field_position">
	                    	...
	                    	<div class="tapsi-woo-delivery-form-group">
	                    		<label class="tapsi-woo-delivery-form-label" style="display:unset!important"><?php _e('Custom CSS', 'woo-delivery'); ?></label>
	                    		<p class="tapsi-woo-delivery-tooltip" tooltip="If you want some custom css to avoid the plugin/theme conflict, put the css code here."><span class="dashicons dashicons-editor-help"></span></p>
	                        	<textarea id="tapsi_woo_delivery_code_editor_css" name="tapsi_woo_delivery_code_editor_css" class="tapsi-woo-delivery-textarea-field" placeholder="" autocomplete="off"><?php echo (isset($other_settings['custom_css']) && !empty($other_settings['custom_css'])) ? stripslashes(esc_attr($other_settings['custom_css'])) : "" ?>
                                </textarea>
	                    	</div>

	                        <input class="tapsi-woo-delivery-submit-btn" type="submit" name="tapsi_delivery_other_settings_form_submit" value="<?php _e('Save Changes', 'woo-delivery'); ?>" />
			...
			<div data-tab="tab10" class="tapsi-woo-delivery-tabcontent">
				<div class="tapsi-woo-delivery-card" style="box-sizing: border-box;padding: 30px 0 30px 30px;">
					<table width="100%">
					    <tr >
					    ...
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Delivery Date</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-yes"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Delivery Time</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-yes"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Individual Pickup Date</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-yes"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Individual Pickup Time</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-yes"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Option for Selecting Home Delivery or Self Pickup</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-yes"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Holidays</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-yes"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Field Position Setting</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-yes"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Every Texts are Translatable</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-yes"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Separate Holidays for Delivery & Pickup</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Hide Plugin Module Completely for Specific Categories/Products</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Hide Plugin Module For Specific Shipping Method</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Hide Plugin Module For Specific User Role</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Category/product/zone/state/postcode wise offdays</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Specific dates as offdays for category/product/zone</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Set Specific dates/Weekdays as offdays for Delivery and Pickup individually</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Next Month Off for Certain Category</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Current Week Off/Next Week Off for Certain Category</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Shipping method wise Offdays</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Date Calendar Language</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Custom Delivery Time Slot</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Ability To Sort Orders Based on Delivery Details on The Woocommerce Orders Page</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Custom Pickup Time Slot</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Hide/Show Timeslot Based on Shipping Zone</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Hide/Show Timeslot Based on Shipping State</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Hide/Show Timeslot Based on Shipping PostCode</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Hide/Show Timeslot Based on Cart Products</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Hide/Show Timeslot Based on Cart Categories</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Hide Timeslot at a Specific Time</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Hide Timeslot for Current day</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Enable Timeslot only for Specific Date</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Hide/Show Pickup timeslot Based on Pickup Location</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Time slot with single time</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Pickup Location</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Disable same day delivery/pickup</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Delivery/Pickup Details on a Calendar View</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Google Calendar Sync</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">WooCommerce shipping methods automatically changed based on Delivey/Pickup</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Dynamically Enable/Disable Delivery/Pickup Based on WooCommerce Shipping</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Delivery Tips Option</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Disable Delivery for Specific Days</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Disable Self Pickup for Specific Days</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Restrict Delivery Option(Cart Amount Base)</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Restrict Pickup Option(Cart Amount Base)</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Restrict Delivery Option Based on Category/Product</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Restrict Pickup Option Based on Category/Product</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Restrict Free Shipping(Cart Amount Base)</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Hide/Show free shipping only for today or some specific dates or any weekdays</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Enable/disable Free Shipping only for current date delivery</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>					    
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Special Open Days</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Set Category Wise Special Open Days for Delivery and Pickup Individually</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Delivery Reports with auto sorting</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Report of Product Quantity</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">One Tab To Control All Deliveries</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Delivery Reports As Excel Sheet(xlsx format)</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Product Quantity Reports As Excel Sheet(xlsx format)</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">WooCommerce App Support Using Order Note</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Filtering and Bulk Action Functionality on WooCommerce Order page </td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Controlling Store closing Time</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Different Store closing Time for Different Weekdays</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Disable Current day or Next Day or Further Day After a Certain Time</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Category wise Cutoff Time</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Different Processing Days for Delivery and Pickup</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Category Wise Processing Days</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Product Wise Processing Days</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Weekday Wise Processing Days</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Shipping Zone Wise Processing Days</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Shipping Method Wise Processing Days</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Different Processing Time for Delivery and Pickup</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Category Wise Processing Time</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Product Wise Processing Time</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Weekday Wise Processing Time</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Time Slot Fee</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Deliver Date Fee</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Weekday wise Delivery Fee</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Delivery Fee/Shipping Method within X Minutes/Hours</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Specific Shipping Method Only for First X Days</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Discount Coupon wise Specific Delivery Days</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Additional Field</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Change Delivery Details from Order Page</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-yes"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Notify Customer About Delivery Details Changing</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    <tr>
					        <td class="tapsi-woo-delivery-proFree-feature">Laundry Service</td>
					        <td class="tapsi-woo-delivery-proFree-free"><span class="dashicons dashicons-no-alt"></span></td>
					        <td class="tapsi-woo-delivery-proFree-pro"><span class="dashicons dashicons-yes"></span></td>
					    </tr>
					    ...
					    <tfoot>
					        <tr>
					            <td class="tapsi-woo-delivery-proFree-feature"></td>
					            <td class="tapsi-woo-delivery-proFree-free"></td>
					            <td class="tapsi-woo-delivery-proFree-pro"><a href="https://tapsi.com/downloads/woocommerce-delivery-date-time-wordpress-plugin/" target="_blank" class="tapsi-woo-delivery-buy-now-btn">Buy Now</a></td>
					        </tr>
					    </tfoot>
					</table>
				</div>
