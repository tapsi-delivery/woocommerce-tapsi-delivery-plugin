...
return array(
	array(
		...
		'type' => 'title',
		'desc' => __( 'Visit the <a href="https://developer.doordash.com/en-US/docs/drive/how_to/manage_credentials" target="_blank">Tapsi Documentation</a> for instructions on how to sign in to the <a href="https://developer.doordash.com/portal/integration/drive/credentials" target="_blank">Tapsi Developer Portal</a> and create your access keys.', 'local-delivery-by-doordash' ),
	),
	array(
		'id' => $prefix . 'developer_id',
		'name' => __( 'Developer ID', 'local-delivery-by-doordash' ),
		'type' => 'text',
		'desc_tip' => __( 'Paste your Developer ID obtained from the Tapsi Developer Portal.', 'local-delivery-by-doordash' ),
	),
	array(
	...
	array(
		...
		'type' => 'text',
		'desc_tip' => __( 'Paste your <em>Production</em> Key ID obtained from the Tapsi Developer Portal.', 'local-delivery-by-doordash' ),
	),
	array(
		...
		'type' => 'text',
		'desc_tip' => __( 'Paste your <em>Production</em> Signing Secret obtained from the Tapsi Developer Portal.', 'local-delivery-by-doordash' ),
	),
	array(
		...
		'name' => __( 'Key ID', 'local-delivery-by-doordash' ),
		'type' => 'text',
		'desc_tip' => __( 'Paste your <em>Sandbox</em> Key ID obtained from the Tapsi Developer Portal.', 'local-delivery-by-doordash' ),
	),
	array(
		...
		'name' => __( 'Signing Secret', 'local-delivery-by-doordash' ),
		'type' => 'text',
		'desc_tip' => __( 'Paste your <em>Sandbox</em> Signing Secret obtained from the Tapsi Developer Portal.', 'local-delivery-by-doordash' ),
	),
	array(
		'id'        => $prefix . 'api_config_settings',
		'name' => __( 'API Configuration', 'local-delivery-by-doordash' ),
	...
	array(
		...
		'options' => array(
			...
			'quoted_rate' => __( 'Charge customer the quoted Tapsi rate', 'local-delivery-by-doordash' ),
			'fixed_rate' => __( 'Charge customer a fixed rate', 'local-delivery-by-doordash' ),
		),
		'desc_tip' => __( 'Choose how the customer will be charged for deliveries. Note: Tapsi will collect all delivery fees and tips directly from the shop owner. You can choose to offer free delivery or pass through any portion of Tapsi’s quoted delivery fee to the customer.', 'local-delivery-by-doordash' ),
	),
	array(
		...
		'desc_tip' => __( 'Add a delivery fee in this amount to customer orders. If used with the "Quoted Rate" option above, customer will be charged this fee in addition to the quoted Tapsi rate.', 'local-delivery-by-doordash' ),
	),
	array(
		'id' => $prefix . 'tipping',
		'name' => __( 'Dasher Tipping', 'local-delivery-by-doordash' ),
		'type' => 'select',
		'desc_tip' => __( 'Select Enabled to allow your customers to add a tip for their Tapsier. 100% of tips are passed on to the Dasher.', 'local-delivery-by-doordash' ),
		'options' => array(
